...
import scha.efer.technique.util.ChatHelper;
...
public class Party extends Team {
    ...
    public static void init() {
        ...
        }.runTaskTimerAsynchronously(TechniquePlugin.get(), 20L * 5, 20L * 5);
        ...
        }.runTaskTimerAsynchronously(TechniquePlugin.get(), 1200L, 1200L);
    }
