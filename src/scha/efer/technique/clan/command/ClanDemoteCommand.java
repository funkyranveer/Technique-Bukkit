...
@CommandMeta(label = {"clan demote"}, async = true)
public class ClanDemoteCommand {
    public void execute(Player player, String targetName) {
        ...
        targetClanPlayer.setRole(ClanRole.MEMBER);
        clan.broadcast(Color.translate("&5" + targetName + " has been demoted to member!"));
        clan.saveAsync();
    }
}
