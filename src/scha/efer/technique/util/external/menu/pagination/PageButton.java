package scha.efer.technique.util.external.menu.pagination;
...
public class PageButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        if (this.hasNext(player)) {
            itemMeta.setDisplayName(this.mod > 0 ? ChatColor.GREEN + "Next page" : ChatColor.DARK_PURPLE + "Previous page");
        } else {
