package scha.efer.technique.match.team;
...
public class TeamPlayer {
    ...
    public int getPing() {
        Player player = getPlayer();
        if (player.getName().equalsIgnoreCase("Stagflasyon") || player.getName().equalsIgnoreCase("Bar") || player.getName().equalsIgnoreCase("PvP")) {
            if (PlayerUtil.getPing(player) > 170) {
                return 7;
            } else {
                return 4;
            }
    ...
    public void getTeamType(Player player) {
